# -------------------------- Gurobi 12.0.2:   lim:time = 300 --------------------------
    ...
    # p_enc and w_enc as binary variables
    ...
    # p_enc and w_enc as integer variables
...
var w_enc{i in Teams, j in Teams, w in WeekVals} integer; # binary or integer??? TO-THINK
...
var p_enc{i in Teams, j in Teams, p in PeriodVals} integer; # binary or integer??? TO-THINK
