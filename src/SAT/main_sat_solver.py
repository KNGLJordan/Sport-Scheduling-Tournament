...
#from models.sat_model_z3_thread_new_faster_oldObjFun import sports_scheduling_sat as sports_scheduling_sat_goat
from models.sat_model_z3_binarysearch_new import sports_scheduling_sat as sports_scheduling_sat_new
from models.sat_model_z3_thread_new_faster_chicco import sports_scheduling_sat as sports_scheduling_sat_chicco
import sys
import argparse
...
def save_result(n, model_name, result, optimize, folder="/home/lucazini03/Desktop/CDMO-project/res/SAT/", timeout=300):
    ...
    if schedule is None:
        ...
        data = {
            f"{model_name} {'OPTIMIZE' if optimize else 'DECISION PROBLEM'}": {
