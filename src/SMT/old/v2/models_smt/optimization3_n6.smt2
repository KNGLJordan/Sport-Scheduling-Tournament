...
(assert (>= abs_balance_0 (- balance_0)))
(assert (= home_count_1 (+ (ite H_1_0 1 0) (ite H_1_2 1 0) (ite H_1_3 1 0) (ite H_1_4 1 0) (ite H_1_5 1 0))))
(assert (= balance_1 (- (* 2 home_count_1) 5)))
(assert (>= abs_balance_1 balance_1))
(assert (>= abs_balance_1 (- balance_1)))
(assert (= home_count_2 (+ (ite H_2_0 1 0) (ite H_2_1 1 0) (ite H_2_3 1 0) (ite H_2_4 1 0) (ite H_2_5 1 0))))
(assert (= balance_2 (- (* 2 home_count_2) 5)))
(assert (>= abs_balance_2 balance_2))
(assert (>= abs_balance_2 (- balance_2)))
(assert (= home_count_3 (+ (ite H_3_0 1 0) (ite H_3_1 1 0) (ite H_3_2 1 0) (ite H_3_4 1 0) (ite H_3_5 1 0))))
(assert (= balance_3 (- (* 2 home_count_3) 5)))
(assert (>= abs_balance_3 balance_3))
(assert (>= abs_balance_3 (- balance_3)))
(assert (= home_count_4 (+ (ite H_4_0 1 0) (ite H_4_1 1 0) (ite H_4_2 1 0) (ite H_4_3 1 0) (ite H_4_5 1 0))))
(assert (= balance_4 (- (* 2 home_count_4) 5)))
(assert (>= abs_balance_4 balance_4))
(assert (>= abs_balance_4 (- balance_4)))
(assert (= home_count_5 (+ (ite H_5_0 1 0) (ite H_5_1 1 0) (ite H_5_2 1 0) (ite H_5_3 1 0) (ite H_5_4 1 0))))
